...
UpcomingReminders::UpcomingReminders(int Ustatus, char UnewReminderTime[],
                                     char UnewDate[], char UscheduledDate[],
                                     char UscheduledTime[]) {
  status = Ustatus;
...
void UpcomingReminders::setNewDetails(char UnewReminderTime[],
                                      char UnewDate[]) {}
void UpcomingReminders::setScheduledDetails(char schedDate[],
                                            char schedTime[]) {}
